  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="absolute inset-0 top-0 bg-[radial-gradient(ellipse_at_center,rgba(168,85,247,0.15),transparent_50%)]" />
        <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
          ...
          >
            ...
            <img src={diamondPng} alt="Gemstone Logo" className="w-32 h-32 md:w-40 md:h-40 object-contain relative z-10 drop-shadow-[0_0_30px_rgba(168,85,247,0.8)] animate-[pulse_3s_ease-in-out_infinite]" />
          </motion.div>
          ...
          >
            <a 
              ...
              className="px-8 py-4 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-all shadow-[0_0_30px_rgba(168,85,247,0.4)] hover:shadow-[0_0_50px_rgba(168,85,247,0.6)] flex items-center justify-center gap-2"
            >
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-center">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20 text-primary shadow-[0_0_15px_rgba(168,85,247,0.15)]">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 text-primary mb-6 group-hover:scale-110 transition-transform group-hover:shadow-[0_0_20px_rgba(168,85,247,0.3)]">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-3xl mx-auto">
            {["BTC", "LTC", "DOGE", "BCH", "PEPE", "RVN"].map((coin, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                key={coin}
                className="px-6 py-3 rounded-full bg-white/[0.03] border border-white/10 text-white font-bold tracking-wider hover:border-primary/50 hover:bg-primary/5 transition-all hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] flex items-center gap-2"
              >
        ...
        <div className="container mx-auto max-w-4xl relative">
          ...
          >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex px-8 py-4 bg-primary text-white font-bold rounded-full hover:bg-primary/90 transition-all shadow-[0_0_30px_rgba(168,85,247,0.4)] hover:shadow-[0_0_50px_rgba(168,85,247,0.6)] items-center justify-center gap-2 relative z-10"
            >
              <Zap className="w-5 h-5 fill-current" />
              Add to Discord Now
            </a>
